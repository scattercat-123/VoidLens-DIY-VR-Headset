...
## Day 1: WHy i wanted to build the headset and research (6 hrs)
...
I researched a lot and finally i decided i will use the [Dual LS029B3SX02 Displays](https://www.alibaba.com/product-detail/LS029B3SX02-vr-head-mounted1440x1440-2K-120Hz_1600064437271.html?...) . 
...
## Day 3: PCB Starting build (5 hrs)
...
## Day 5-7 : Cad modeling grind (13 hrs)
...
## Day 8: Modeled the Pcb holder, aesthetics (6 hrs)
...
## Day 9: Final changes, adding ping pong ball. (4 hrs)
